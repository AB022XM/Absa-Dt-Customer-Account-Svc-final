...
@AnalyzeClasses(packagesOf = AbsaDtCustomerAccountSvcfinalApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(AbsaDtCustomerAccountSvcfinalApp.class), alwaysTrue())
